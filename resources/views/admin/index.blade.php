...
<head>
    ...
    <link rel="stylesheet" href="http://127.0.0.1:8000/css/parsley.css">
</head>
<body>
<div class="header">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <!-- Logo -->
                <div class="logo">
                    <h1><a href="http://127.0.0.1:8000/admin">Admin</a></h1>
                </div>
            </div>
    ...
    <div class="sidebar content-box" style="display: block;">
        <ul class="nav">
            ...
            <li class="submenu">
                ...
                <!-- Sub menu -->
                <ul>
                    <li><a href="http://127.0.0.1:8000/admin/product">Products</a></li>
